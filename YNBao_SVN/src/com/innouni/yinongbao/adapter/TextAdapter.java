...
public class TextAdapter extends ArrayAdapter<HashMap<String, String>> {
	...
	public TextAdapter(Context context, List<HashMap<String, String>> listData,
			int sId, int nId, int type) {
		super(context, R.string.err_no_data, listData);
		mContext = context;
		mListData = listData;
	...
	public void setSelectedPosition(int pos) {
		if (mListData != null && pos < mListData.size()) {
			selectedPos = pos;
			selectedText = mListData.get(pos).get("title");
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (mListData != null) {
			if (position < mListData.size()) {
				mString = mListData.get(position).get("title");
			}
