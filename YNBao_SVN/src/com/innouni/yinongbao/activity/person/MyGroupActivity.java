 ...
 * 
 */
public class MyGroupActivity extends Activity implements
	...
	private ArrayList<MyGroup> list_data;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		list_data = new ArrayList<MyGroup>();
		initHeader();
		initView();
	}
	...
	private class GetDataTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... arg0) {
			String requery = comFunction.getDataFromServer("get_fav_my_group",
					paramsList, MyGroupActivity.this);
		...
		protected void onPostExecute(Void result) {
			...
			if (message != null) {
				if (code.equals(HttpCode.SERVICE_SUCCESS)) {
					...
					comFunction.toastMsg(message, MyGroupActivity.this);
				}
			} else {
