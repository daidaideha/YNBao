...
import com.innouni.yinongbao.adapter.MyTieziAdapter;
 ...
 * 
 */
public class MyTieziActivity extends Activity implements
	...
	private MyTieziAdapter adapter;
	private GetDataTask getDataTask;
	private int pageCount = 1;
	private ArrayList<MyTiezi> list_data;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		list_data = new ArrayList<MyTiezi>();
		initHeader();
		initView();
	}
	...
	private void initView() {
		...
		adapter = new MyTieziAdapter(this);
	...
	private class GetDataTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... arg0) {
			String requery = comFunction.getDataFromServer("get_int_my_blog",
					paramsList, MyTieziActivity.this);
		...
		protected void onPostExecute(Void result) {
			...
			if (message != null) {
				if (code.equals(HttpCode.SERVICE_SUCCESS)) {
					...
					comFunction.toastMsg(message, MyTieziActivity.this);
				}
			} else {
				comFunction.toastMsg(getString(R.string.toast_net_link),
						MyTieziActivity.this);
			}
