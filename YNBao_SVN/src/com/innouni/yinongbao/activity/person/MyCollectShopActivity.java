...
import com.innouni.yinongbao.adapter.MyCollectShopAdapter;
 ...
 * 
 */
public class MyCollectShopActivity extends Activity implements
	...
	private ArrayList<Shop> list_data;
	...
	private void initView() {
		...
		adapter = new MyCollectShopAdapter(this);
	...
	private class GetDataTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... arg0) {
			String requery = comFunction.getDataFromServer("get_fav_my_shop",
					paramsList, MyCollectShopActivity.this);
		...
		protected void onPostExecute(Void result) {
			...
			if (message != null) {
				if (code.equals(HttpCode.SERVICE_SUCCESS)) {
					...
					comFunction.toastMsg(message, MyCollectShopActivity.this);
				}
			} else {
				comFunction.toastMsg(getString(R.string.toast_net_link),
						MyCollectShopActivity.this);
			}
