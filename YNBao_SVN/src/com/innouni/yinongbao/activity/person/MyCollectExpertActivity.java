...
import com.innouni.yinongbao.adapter.MyCollectExpertAdapter;
 ...
 * 
 */
public class MyCollectExpertActivity extends Activity implements
	...
	private MyCollectExpertAdapter adapter;
	private GetDataTask getDataTask;
	private int pageCount = 1;
	private ArrayList<ExperUnit> list_data;
	...
	private void initView() {
		...
		adapter = new MyCollectExpertAdapter(this);
	...
	private class GetDataTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... arg0) {
			String requery = comFunction.getDataFromServer("get_fav_my_expert",
					paramsList, MyCollectExpertActivity.this);
			...
			try {
				...
				if (code.equals(HttpCode.SERVICE_SUCCESS)) {
					...
					for (int i = 0; i < jArray_questions.length(); i++) {
						ExperUnit question = new ExperUnit(
		...
		protected void onPostExecute(Void result) {
			...
			if (message != null) {
				if (code.equals(HttpCode.SERVICE_SUCCESS)) {
					...
					comFunction.toastMsg(message, MyCollectExpertActivity.this);
				}
			} else {
				comFunction.toastMsg(getString(R.string.toast_net_link),
						MyCollectExpertActivity.this);
			}
