...
import com.innouni.yinongbao.activity.person.HelpCenterActivity;
...
import com.innouni.yinongbao.activity.person.MyGroupActivity;
import com.innouni.yinongbao.activity.person.PublicPostsActivity;
...
public class PersonFragment extends Fragment implements OnClickListener {
	 ...
	 * 区分我问的,问我的,我答的
	 */
	public static final int TYPE_MY_ASK = 0;
	...
	public void onAttach(Activity activity) {
		...
		listener = (CollectOnClickListener)activity;
	}
	...
	private class MyTabClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			case R.id.rl_person_group:
				 ...
				 * add by Hugj
				 */
				new IntentToOther(getActivity(), MyGroupActivity.class, null);
				break;
			default:
				break;
			}
	...
	private class MyBodyerClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			case R.id.tv_person_myask:
				...
				bundle.putInt("type", TYPE_MY_ASK);
				new IntentToOther(getActivity(), MyAskQuestionActivity.class, bundle);
				break;
			case R.id.rl_person_askme:
				...
				bundle1.putInt("type", TYPE_ASK_ME);
				new IntentToOther(getActivity(), MyAskQuestionActivity.class, bundle1);
				break;
			case R.id.tv_person_myreplay:
				...
				bundle2.putInt("type", TYPE_MY_ANSWER);
				new IntentToOther(getActivity(), MyAskQuestionActivity.class, bundle2);
				break;
			case R.id.tv_person_post:
				/**
				 * add by Hugj
				 */
				new IntentToOther(getActivity(), PublicPostsActivity.class, null);
				break;
			case R.id.tv_person_collect:
				/**
				 * add by Hugj
				 */
				listener.collectOnClick();
				break;
			case R.id.tv_person_help:
				/**
				 * add by Hugj
				 */
				new IntentToOther(getActivity(), HelpCenterActivity.class, null);
				break;
	 ...
	 * 我的收藏点击事件回调接口
	 */
	private CollectOnClickListener listener;
