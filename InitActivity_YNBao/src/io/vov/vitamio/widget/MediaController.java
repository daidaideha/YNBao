	...
	private void initControllerView(View v) {
		...
		mCurrentTime = (TextView) v.findViewById(getResources()
				.getIdentifier("mediacontroller_time_current", "id",
						mContext.getPackageName()));
		tv_fullscreen=(TextView)v.findViewById(getResources().getIdentifier(
				"mediacontroller_fillscrean", "id", mContext.getPackageName()));
	...
	public void show(int timeout) {
		if (!mShowing && mAnchor != null && mAnchor.getWindowToken() != null) {
			...
			if (mFromXml) {
				...
				setWindowLayoutType();
				mWindow.showAsDropDown(mAnchor, 0, - getViewHeight(mWindow.getContentView()) * 3 / 2);
				System.out.println("mAnchor.getHeight(): " + mAnchor.getHeight() + " location[1]: " 
						+ location[1] + " mWindow.getHeight(): " + getViewHeight(mWindow.getContentView())); 
...
//						anchorRect.left, anchorRect.bottom);
	...
	public void setOnMyClickListener(
			OnMyClickListener mClickListener) {
